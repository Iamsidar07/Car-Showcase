                ...
                <div className='w-full h-fit'>
                    <div className='w-full h-full min-h-[300px] relative rounded '>
                        <Image
                            ...
                            alt='car'
                            fill
                            className='object-contain w-full h-full scale-[110%] md:hover:scale-[154%] md:hover:-rotate-6 md:hover:translate-x-1/4 z-30 transition-all duration-700 ease-linear'
                        />
                        <Image
