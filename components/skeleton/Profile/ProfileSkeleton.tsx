...
const ProfileSkeleton = () => {
    return (
        <section className=' relative pt-16 md:pt-16 animate-pulse '>
            <div className='relative h-52 md:h-64 bg-gray-400'>
            </div>
            <div className='max-w-[1440px] mx-auto'>
                <div className={`relative bg-zinc-600`}>
                    ...
                    <div className='h-24 w-24 md:h-40 md:w-40 absolute left-2 -bottom-8 md:-bottom-10 rounded-full p-2 md:p-2 shadow-2xl border-4 md:border-[8px] bg-white'>
                    </div>


                </div>
                <div className='rounded-lg w-full pt-9 md:pt-12 p-2 md:p-6 leading-5 gap-2'>
                    <h1 className='text-lg md:text-2xl font-bold h-3 w-full md:max-w-sm  bg-gray-400'></h1>
                    <p className='text-gray-500 text-sm h-3 w-full md:max-w-sm mt-2 bg-gray-400'></p>
                    <p className='text-gray-500 text-sm h-3 w-full md:max-w-sm mt-2 bg-gray-400'></p>
                </div>
