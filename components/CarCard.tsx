...
const CarCard = ({
  ...
  const removeFromFavorite = async (id: string | undefined) => {
    ...
    const isReallyWantToDelete = confirm(
      `Do you really want to remove this car with id:${id} from favorites.`,
    );
