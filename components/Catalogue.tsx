    ...
    return (
        <section id='explore' className='w-full relative mt-12 p-4 md:p-16 max-w-[1440px] mx-auto'>
            ...
            <div className='flex items-baseline justify-between mt-12'>
                <h2 className='font-bold text-left text-lg md:text-2xl dark:text-pink-500'>🚀 Recommendations</h2>
                <Link href={'/view-all'} className='text-blue-600 capitalize dark:text-pink-500'>
                    view all
                </Link>
            </div>
            ...
            <div className='flex items-baseline justify-between mt-12'>
                <h2 className='font-bold text-left text-lg md:text-2xl dark:text-indigo-400'>🔥 Hot Collections</h2>
                <Link href={'/view-all'} className='text-blue-600 capitalize dark:text-indigo-400'>
                    view all
                </Link>
            </div>
            <div className='grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 2xl:grid-cols-4  gap-2 md:gap-3 mt-6'
...

            {
                ...
                (
                    <CustomButton title='Show More'
                        type='button'
                        containerStyle='mt-12 mx-auto bg-blue-600 text-white px-6 border rounded-full dark:bg-slate-700 dark:text-slate-300 dark:border-slate-600' handleClick={handleClick}
                    />)
            }
        </section>
    )
